...
import { selectIsTotalExpensesLoaded } from '../../redux/expenses/expenses.selectors';

import WithLoader from '../../components/with-loader/with-loader.component';
import Meter from './meter.component';

const mapStateToProps = createStructuredSelector({
	isLoading: state => !selectIsUserSettingsLoaded(state) && !selectIsTotalExpensesLoaded(state)
})
